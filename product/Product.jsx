        ...
        <div className='mt-14 mb-12'>
            <div className='container'>
                ...
                <div className='text-center mb-10 max-w-[600px] mx-auto'>
                    ...
                    <h1 data-aos="fadeup" className='text-3xl font-bold'>Top Selling Products</h1>
                ...
                gap-5'>
                    ...
                    <div className='flex justify-center'>
                        <button className='text-center mt-10 cursor-pointer bg-primary text-white py-1  rounded-md px-2'
